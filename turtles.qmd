...
t.test(bp_turtles$prob, as.numeric(ds_turtles$variables[,"model"]))
...
```{r}
hist_length_turtles_norm_bad <- 200
...
bp_turtles_norm_bad <- binary_probabilities_from_stats(res_turtles_norm_bad$stats)
hist_turtles_norm_bad_schad <- compute_bootstrapped_histories(bp_turtles_norm_bad, history_length = hist_length_turtles_norm_bad, n_histories = n_histories, step = hist_step_turtles_norm_bad,
...
plot_log_p_histories(hist_turtles_norm_bad_schad, "Schad")
...
save_histories("hist_turtles_norm_bad",
               ...
               schad = hist_turtles_norm_bad_schad,
