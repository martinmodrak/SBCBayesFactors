...
hist_bad_giviti <- compute_bootstrapped_histories(binary_probabilities_from_stats(res_bin_bad$stats) , history_length = 100, n_histories = 100,
                                            compute_giviti_history, min_sim_id = 5)
plot_log_p_histories(hist_bad_giviti, "Giviti")
```
