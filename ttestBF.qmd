...
miscalibration_p <- miscalibration_resampling_p(bp$prob, bp$simulated_value)
miscalibration_p
my_reliability_diag(bp)
```
...
saveRDS(list(t  = t_res,
  ...
  file.path(cache_dir, paste0("ttest_post_stats.rds")))
...
miscalibration_p_fixed <- miscalibration_resampling_p(bp_fixed$prob, bp_fixed$simulated_value)
miscalibration_p_fixed
reliability_diag_fixed <- my_reliability_diag(bp_fixed)
reliability_diag_fixed

t_res_fixed <-  t.test(bp_fixed$prob, mu = 0.5)
t_res_fixed
```
...
bp_fixed_high <- bp_fixed |> filter(sim_id %in% which(high_sd_fixed))
bp_fixed_low <- bp_fixed |> filter(sim_id %in% which(!high_sd_fixed))

miscalibration_p_fixed_high <- miscalibration_resampling_p(bp_fixed_high$prob, bp_fixed_high$simulated_value)
miscalibration_p_fixed_high
reliability_diag_fixed_high <-  my_reliability_diag(bp_fixed_high)


miscalibration_p_fixed_low <- miscalibration_resampling_p(bp_fixed_low$prob, bp_fixed_low$simulated_value)
reliability_diag_fixed_low <-  my_reliability_diag(bp_fixed_low)

saveRDS(list(
       sbc_res = res_fixed,
       hist = hist_fixed,
       t  = t_res_fixed,
       miscalibration_p = miscalibration_p_fixed,
       reliability_diag = reliability_diag_fixed,
       miscalibration_p_high = miscalibration_p_fixed_high,
       reliability_diag_high = reliability_diag_fixed_high,
       miscalibration_p_low = miscalibration_p_fixed_low,
       reliability_diag_low = reliability_diag_fixed_low
       ),
  file.path(cache_dir, paste0("ttest_fixed_stats.rds")))
...
my_reliability_diag(bp_inv1psquared)
...
bp_inv1psquared_high <- bp_inv1psquared |> filter(sim_id %in% which(high_sd_inv1psquared))
bp_inv1psquared_low <- bp_inv1psquared |> filter(sim_id %in% which(!high_sd_inv1psquared))

miscalibration_resampling_p(bp_inv1psquared_high$prob, bp_inv1psquared_high$simulated_value)
reliabilitydiag::reliabilitydiag(x = bp_inv1psquared_high$prob, y = bp_inv1psquared_high$simulated_value)
miscalibration_resampling_p(bp_inv1psquared_low$prob, bp_inv1psquared_low$simulated_value)
reliabilitydiag::reliabilitydiag(x = bp_inv1psquared_low$prob, y = bp_inv1psquared_low$simulated_value)
...
bp_cauchy_high <- bp_cauchy |> filter(sim_id %in% which(high_sd_cauchy))
bp_cauchy_low <- bp_cauchy |> filter(sim_id %in% which(!high_sd_cauchy))

miscalibration_resampling_p(bp_cauchy_high$prob, bp_cauchy_high$simulated_value)
reliabilitydiag::reliabilitydiag(x = bp_cauchy_high$prob, y = bp_cauchy_high$simulated_value)
miscalibration_resampling_p(bp_cauchy_low$prob, bp_cauchy_low$simulated_value)
reliabilitydiag::reliabilitydiag(x = bp_cauchy_low$prob, y = bp_cauchy_low$simulated_value)
