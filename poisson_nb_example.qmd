...
```{r}
hist_ignore_all <- compute_bootstrapped_histories(res_pnb_ignore_all$stats, history_length = 100, n_histories = 100,
                                            compute_log_gamma_history)
plot_log_gamma_histories(hist_ignore_all)
```
...
plot_ecdf_diff(res_pnb_ignore_half)
plot_binary_calibration_diff(res_pnb_ignore_half$stats, method = "round")
```


```{r}
hist_ignore_half <- compute_bootstrapped_histories(res_pnb_ignore_half$stats, history_length = 1000, n_histories = 100,
                                            compute_log_gamma_history)
plot_log_gamma_histories(hist_ignore_half)
```
...
```{r}
hist_vari <- compute_bootstrapped_histories(res_pnb_vari$stats, history_length = 1000, n_histories = 100, step = 10,
                                            compute_log_gamma_history)

bp_vari<- binary_probabilities_from_stats(res_pnb_vari$stats)
hist_vari_schad <- compute_bootstrapped_histories(bp_vari, history_length = 1000, n_histories = 100, step = 10,
                                            compute_schad_history)

# hist_vari_schad_bf <- compute_bootstrapped_histories(bp_vari, history_length = 1000, n_histories = 100, step = 10,
#                                             compute_schad_bf_history)


hist_vari_miscalibration <- compute_bootstrapped_histories(bp_vari, history_length = 200, n_histories = 100, step = 10,
                                                           compute_miscalibration_history, min_sim_id = 1)


plot_log_gamma_histories(hist_vari)
plot_log_p_histories(hist_vari_schad, "Schad")
#plot_log_p_histories(hist_vari_schad_bf, "Schad BF")
plot_log_p_histories(hist_vari_miscalibration, "Miscalibration resampling") + expand_limits(x = 1000, y = min(hist_vari$log_gamma - hist_vari$log_gamma_threshold))
...
```{r}
hist_bias <- compute_bootstrapped_histories(res_pnb_bias$stats, history_length = 100, n_histories = 100, step = 5,
                                            compute_log_gamma_history)

bp_bias <- binary_probabilities_from_stats(res_pnb_bias$stats)
hist_bias_schad <- compute_bootstrapped_histories(bp_bias, history_length = 100, n_histories = 100, step = 5,
                                            compute_schad_history)


hist_bias_schad_bf <- compute_bootstrapped_histories(bp_bias, history_length = 100, n_histories = 100, step = 5,
                                            compute_schad_bf_history)


hist_bias_brier <- compute_bootstrapped_histories(bp_bias, history_length = 100, n_histories = 100, step = 1,
                                            compute_brier_history, min_sim_id = 10)


hist_bias_miscalibration <- compute_bootstrapped_histories(bp_bias, history_length = 100, n_histories = 100, step = 5,
                                                           compute_miscalibration_history, min_sim_id = 1)

               
plot_log_gamma_histories(hist_bias)
plot_log_p_histories(hist_bias_brier, "Brier resampling")
plot_log_p_histories(hist_bias_schad, "Schad") + expand_limits(y = log(1e-32))
plot_log_p_histories(hist_bias_schad_bf, "Schad BG") + expand_limits(y = log(1e-32))
plot_log_p_histories(hist_bias_miscalibration, "Miscalibration resampling") + expand_limits(y = log(1e-32))
...
plot_binary_calibration_diff(res_pnb_bias_vari$stats, method = "round")
```

```{r}
N <- 1000
microbenchmark::microbenchmark(setup = quote({
  x <- runif(N)
...
```{r}
hist_length_vari <- 500
hist_step_vari <- 10
hist_bias_vari <- compute_bootstrapped_histories(res_pnb_bias_vari$stats, history_length = hist_length_vari, n_histories = n_histories, step = hist_step_vari,
                                            compute_log_gamma_history)

bp_bias_vari <- binary_probabilities_from_stats(res_pnb_bias_vari$stats)
hist_bias_vari_schad <- compute_bootstrapped_histories(bp_bias_vari, history_length = hist_length_vari, n_histories = n_histories, step = hist_step_vari,
                                            compute_schad_history)


hist_bias_vari_schad_bf <- compute_bootstrapped_histories(bp_bias_vari, history_length = hist_length_vari, n_histories = n_histories, step = hist_step_vari,
                                            compute_schad_bf_history)


hist_bias_vari_brier <- compute_bootstrapped_histories(bp_bias_vari, history_length = hist_length_vari, n_histories = n_histories, step = hist_step_vari,
                                            compute_brier_history, min_sim_id = 10)


hist_bias_vari_miscalibration <- compute_bootstrapped_histories(bp_bias_vari, history_length = hist_length_vari, n_histories = n_histories, step = hist_step_vari,
                                                           compute_miscalibration_history, min_sim_id = 1)


hist_bias_vari_hl <- compute_bootstrapped_histories(bp_bias_vari, history_length = hist_length_vari, n_histories = n_histories, step = hist_step_vari,
                                                           compute_hosmer_lemeshow_history, min_sim_id = 10)

               
plot_log_gamma_histories(hist_bias_vari)
plot_log_p_histories(hist_bias_vari_brier, "Brier resampling")
plot_log_p_histories(hist_bias_vari_schad, "Schad")
plot_log_p_histories(hist_bias_vari_schad_bf, "Schad BF")
plot_log_p_histories(hist_bias_vari_miscalibration, "Miscalibration resampling")
plot_log_p_histories(hist_bias_vari_hl, "Hosmer-Lemeshow", min_sim_id = 50)
