...
backend_H0 <- SBC_backend_lmBF(f_H0, whichRandom = c("subj", "item"), rscaleFixed = 0.5, rscaleRandom = 1)
backend_H1 <- SBC_backend_lmBF(f_H1, whichRandom = c("subj", "item"), rscaleFixed = 0.5, rscaleRandom = 1)
