...
intervals <- future.apply::future_replicate(1000, {
  ...
  if(m_probs == 0) {
    ...
    lwr_func <- \(mu_lwr) SBCBayesFactors:::ml_dap_p(probs, mu_lwr, B = 100000, alternative = "less") - 0.025
  ...
  if(m_probs == 1) {
    ...
    upr_func <- \(mu_upr) SBCBayesFactors:::ml_dap_p(probs, mu_upr, B = 100000, alternative = "greater") - 0.025
