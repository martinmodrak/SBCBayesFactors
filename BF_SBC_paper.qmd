...
```{r}
plot_log_gamma_histories(hist_large_model_space$log_gamma |> filter(!grepl("m_bad", variable) | grepl("m_bad.[16].$", variable)) |> mutate(variable = gsub("_bad", "", variable)))
plot_log_gamma_histories(hist_large_model_space$log_gamma_short)
```
