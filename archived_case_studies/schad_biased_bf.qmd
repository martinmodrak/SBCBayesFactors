...
```{r cluster}
setup_cluster(max_local_workers = 8)
```
...
if(cache_fits) {
  ...
  backend_2step_H0_1 <-SBC_backend_cached(backend_2step_H0_1,
            cache_dir = fits_cache_dir)


  backend_2step_H0_correct <- SBC_backend_cached(backend_2step_H0_correct,
            cache_dir = fits_cache_dir)
}
```
