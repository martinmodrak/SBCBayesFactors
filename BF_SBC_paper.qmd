...
In the examples we ran, prediction calibration checks tended to have higher power to detect discrepancies than SBC for the model index and sometimes even than SBC for the log likelihood.
