...
post_t <- t.test(bp_post$prob, mu = prob1_prior)
post_t
post_miscalibration_p <- miscalibration_resampling_p(bp_post$prob, bp_post$simulated_value)
...
saveRDS(
  list(t  = post_t,
       miscalibration_p = post_miscalibration_p),
  file.path(cache_dir, paste0("lmbf_ranef_post_presence_", N_for_filename, "_tests.rds")))
