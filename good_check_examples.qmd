...
metrics_good_cauchy <- calibration_metrics(res_good_cauchy)
print(metrics_good_cauchy)
saveRDS(metrics_good_cauchy,
  file.path(cache_dir, paste0("good_cauchy_metrics.rds")))
...
metrics_good_norm2 <- calibration_metrics(res_good_norm2)
print(metrics_good_norm2)
saveRDS(metrics_good_norm2,
  file.path(cache_dir, paste0("good_norm2_metrics.rds")))
