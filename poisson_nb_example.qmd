...
calibration_metrics(res_pnb_correct)
```
...
calibration_metrics(res_pnb_ignore_half)
```
...
calibration_metrics(res_pnb_vari)
...
calibration_metrics(res_pnb_bias)
```
```{r}
...
calibration_metrics(res_pnb_bias_vari)
```
