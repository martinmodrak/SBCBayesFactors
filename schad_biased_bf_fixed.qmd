...
```{r}
idx <- 1:500
idx_to_test <- purrr::map_lgl(idx, \(i) {
f1 <- cached_fit_filename(cache_dir = fits_cache_dir, backend_2step_H0, ds_2step$generated[[i]], suffix = "_bridgesampling")
f2 <- cached_fit_filename(cache_dir = fits_cache_dir, backend_2step_H1, ds_2step$generated[[i]], suffix = "_bridgesampling")
