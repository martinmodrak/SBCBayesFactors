...
calibration_metrics(res_bin_flip)
```
...
calibration_metrics(res_bin_small)
```
...
bp_bin_bad <- binary_probabilities_from_stats(res_bin_bad$stats)

calibration_metrics(res_bin_bad)
```
...
hist_bad_ttest <- compute_bootstrapped_histories(bp_bin_bad , history_length = 100, n_histories = 100,
                                            compute_ttest_history, min_sim_id = 5)


hist_bad_brier <- compute_bootstrapped_histories(bp_bin_bad, history_length = 100, n_histories = 100,
                                            compute_brier_history, min_sim_id = 5)

hist_bad_miscalibration <- compute_bootstrapped_histories(bp_bin_bad, history_length = 100, n_histories = 100,
                                            compute_miscalibration_history, min_sim_id = 10)
