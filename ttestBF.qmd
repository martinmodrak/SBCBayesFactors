...
metrics_fixed_high <- calibration_metrics(res_fixed_high)
metrics_fixed_low <- calibration_metrics(res_fixed_low)
...
metrics_inv1psquared_high <- calibration_metrics(res_inv1psquared_high)
metrics_inv1psquared_low <- calibration_metrics(res_inv1psquared_low)
...
metrics_cauchy_high <- calibration_metrics(res_cauchy_high)
metrics_cauchy_low <- calibration_metrics(res_cauchy_low)
